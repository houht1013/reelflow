...
- **Triple Framework Support**: 
  ...
  - TanStack Start for developers seeking a lightweight React alternative
...
- **Rich Component Libraries**:
  - [shadcn/ui](https://ui.shadcn.com/) for Next.js and TanStack Start
...
4. **Framework Freedom**: Choose between React (Next.js / TanStack Start) and Vue (Nuxt.js) while keeping all the powerful features
