    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          closeButton: 'absolute top-0 right-0 h-5 w-5 flex justify-center items-center p-0 bg-popover border border-border rounded-full cursor-pointer z-[1] transition-[background-color,border-color,transform] duration-100 transform translate-x-[35%] -translate-y-[35%] hover:bg-accent hover:border-accent-foreground/20',
        },
      }}
      {...props}
    />
