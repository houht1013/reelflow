...
export const en: Locale = {
  ...
  pricing: {
    ...
    checkout: {
      ...
      qrHint: "Scan with Alipay to complete payment",
      qrExpiresIn: "Time left",
      paidTitle: "Payment successful",
      paidHint: "Your plan is active — head to the workspace and start creating.",
      backToWorkbench: "Back to workspace",
      viewCredits: "View my credits",
      expiredTitle: "QR code expired",
      expiredHint: "This QR code is no longer valid. Please regenerate and scan again.",
  ...
  reelflow: {
    ...
    shell: {
      ...
      settings: {
        ...
        freePlan: "Free",
        viewPlans: "View plans",
        profileDesc: "Manage your account info.",
        subscriptionDesc: "View and manage your subscription.",
        generalDesc: "Appearance and preferences.",
        email: "Email",
        role: "Role",
        roleAdmin: "Admin",
        roleMember: "Member",
        account: "Account",
        upgradeHint: "Upgrade for more credits and premium templates.",
      },
      comingSoon: "Soon",
      groups: {
        main: "Workspace",
      ...
      nav: {
        ...
        invites: "Invites",
        invitesHint: "Invite friends, earn bonus credits",
    ...
    assetLibrary: {
      ...
      uploadTitle: "Upload image",
      uploadDescription: "Upload an image file, up to 10 MB.",
      selectMode: "Select",
      selectAll: "Select all",
      exitSelect: "Done",
      selected: "{n} selected",
      batchDelete: "Delete selected",
      batchConfirmTitle: "Delete selected assets?",
      batchConfirmBody: "This permanently removes the {n} selected assets and can't be undone.",
      batchRemoveSuccess: "Selected assets deleted",
